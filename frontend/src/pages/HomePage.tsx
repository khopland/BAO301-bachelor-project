  ...
  return (
    <main className="ml-[5rem] p-5 flex flex-col h-[100vh]">
      <article className='text-on-primary text-center flex flex-col gap-5 px-[20%] py-[10%] no-elevate bg-gradient-to-r from-purple-500 to-pink-500 items-center justify-center'>
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium mollitia ea sequi nam odit est, porro obcaecati explicabo tempora sunt, voluptatem id ullam nihil eligendi tempore dolorem modi. Quo quod, fuga consequuntur veritatis neque fugiat saepe sit earum ipsam odio! Maxime cupiditate in, suscipit tempora veniam quae incidunt dicta fugiat.</p>
      </article>
